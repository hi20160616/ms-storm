...
import (
	...
	"github.com/hi20160616/ms-storm/internal/job"
	"github.com/hi20160616/ms-storm/internal/server"
...
func main() {
	...
	// Job
	g.Go(func() error {
		log.Printf("[%s] Job is working", configs.Data.MS["storm"].Title)
